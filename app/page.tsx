...
// 🛠️ CORREGIDO: Al ser "export default" en tu componente, se importa SIN llaves {}.
...
export default async function HomePage() {
  ...
  return (
    <div className="w-full bg-white pb-24">
      ...
      {/* =========================================================
          1. ESTRUCTURA PARA ESCRITORIO & TABLETAS (Hero Informativo)
          ========================================================= */}
      <div className="hidden md:block">
        {/* HERO DESKTOP INFORMATIVO */}
        <section className="relative overflow-hidden bg-stone-50 border-b border-stone-100 px-4 pt-24 pb-24 sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-left">
                ...
                <h1 className="text-4xl font-light tracking-tight text-stone-900 lg:text-6xl leading-tight">
      ...
      <div className="block md:hidden">
        {/* HERO MÓVIL COMPACTO */}
        <section className="relative overflow-hidden bg-stone-50 px-4 pt-20 pb-14 text-center border-b border-stone-100">
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#e7e5e4_1px,transparent_1px),linear-gradient(to_bottom,#e7e5e4_1px,transparent_1px)] bg-[size:3rem_3rem] opacity-25 pointer-events-none" />
          
          <div className="relative">
            <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-amber-700 block mb-3">
              Boutique Santo Domingo
            </span>
            <h1 className="text-3xl font-light tracking-tight text-stone-900 leading-tight">
              Tu <span className="font-serif italic text-amber-800">Esencia</span> Exclusiva
            </h1>
            <p className="mt-3 text-xs text-stone-500 font-light max-w-xs mx-auto">
              Casas perfumeras de prestigio con envío a toda la República Dominicana.
            </p>
          </div>
        </section>

        {/* CARRUSEL DE SELECCIÓN OSCURO EXCLUSIVO PARA MÓVIL */}
        <ProductCarouselMobile />
      </div>

      {/* =========================================================
          3. SECCIÓN COMÚN: FORMATOS DE VIAJE / DECANT ÚNICO (IMAGEN CONTROLADA)
          ========================================================= */}
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 mt-24 md:mt-32 mb-16">
        <div className="border-t border-stone-100 pt-16 md:pt-24">
          
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            
            {/* Bloque de Texto (Toma 7 columnas) */}
            ...
            {/* Imagen del Decant (Ajustada a un tamaño moderado y centrada) */}
            <div className="md:col-span-5 flex justify-center md:justify-end">
              <div className="relative aspect-square w-full max-w-[280px] bg-stone-50 border border-stone-100 p-2 group overflow-hidden shadow-sm">
                <img 
                  src="/images/ato.jpg" 
                  alt="Colección de decants de perfume de 10ml en atomizadores matte black"
