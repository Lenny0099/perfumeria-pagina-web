      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 pb-12 border-b border-stone-800">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-xs font-light text-stone-400 leading-relaxed max-w-xs">
        ...
        {/* Créditos Finales */}
        <div className="mt-12 flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] font-light tracking-wider text-stone-500 uppercase">
